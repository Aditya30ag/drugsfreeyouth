    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-100 rounded-3xl p-8 sm:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1">Scan</h4>
                      <p className="text-gray-600">Use your phone to scan the QR code</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Submit anonymous drug activity reports</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-1">Alert</h4>
                      <p className="text-gray-600">Authorities receive immediate alerts for action</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <div className="bg-white rounded-2xl p-8 shadow-lg inline-block">
                  ...
                  <p className="text-xs text-gray-500">Anonymous Reporting</p>
                </div>
              </div>
            </div>
