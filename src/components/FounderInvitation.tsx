      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
          {roles.map((role, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center text-primary-foreground hover:bg-white/20 transition-all duration-300">
              <h3 className="font-bold text-lg mb-2">{role.title}</h3>
              <p className="text-primary-foreground/90 text-sm">{role.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
            <button className="bg-white text-primary font-bold py-4 px-8 rounded-xl hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
              Join the Movement
            </button>
            <button className="bg-primary-foreground text-primary font-bold py-4 px-8 rounded-xl hover:bg-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
              Contact Suhail
            </button>
          </div>
        </div>
