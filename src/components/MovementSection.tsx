    ...
    <section className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-primary rounded-2xl p-8 sm:p-12 text-primary-foreground mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-2xl p-6">
              ...
              <h3 className="text-lg font-bold text-foreground mb-2">Community Power</h3>
              <p className="text-muted-foreground">Mobilizing neighborhoods, families, and local leaders</p>
            </div>
            ...
            <div className="bg-card rounded-2xl p-6">
              ...
              <h3 className="text-lg font-bold text-foreground mb-2">Law Enforcement</h3>
              <p className="text-muted-foreground">Strategic partnerships with police departments</p>
            </div>
            ...
            <div className="bg-card rounded-2xl p-6">
              ...
              <h3 className="text-lg font-bold text-foreground mb-2">Youth Leadership</h3>
              <p className="text-muted-foreground">Empowering young people to lead change</p>
            </div>
          </div>
        </div>
      </div>
