            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  ...
                  <h3 className="font-bold text-foreground mb-2">The Problem</h3>
                  <p className="text-muted-foreground text-sm">Rising drug use among youth in Mangaluru and Udupi</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-muted rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <h3 className="font-bold text-foreground mb-2">The Realization</h3>
                  <p className="text-muted-foreground text-sm">Isolated awareness events weren&apos;t enough</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-muted rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-primary" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-muted-foreground text-sm">A collaborative, action-driven movement</p>
                </div>
              </div>
