...
const CampaignPillars: React.FC = () => {
  ...
  return (
    <div className="min-h-full bg-white pt-12 sm:pt-16 px-3 sm:px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed px-2 sm:px-4">
      ...
      <section className="w-full py-12 sm:py-16 md:py-20 px-3 sm:px-4 md:px-6 bg-gradient-to-r from-blue-50 to-indigo-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-4 sm:space-y-6 order-1 lg:order-2">
              <div className="inline-block bg-red-100 text-red-600 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-semibold uppercase tracking-wide">
              ...
              {/* Personal Quote */}
              <blockquote className="text-lg sm:text-xl md:text-2xl text-gray-700 italic leading-relaxed border-l-4 border-blue-500 pl-4 sm:pl-6 my-6 sm:my-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4">
                <button className="bg-red-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold shadow-lg hover:bg-red-700 transition duration-300 text-sm sm:text-base">
                  Know More
                </button>
                <button className="bg-blue-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold shadow-lg hover:bg-blue-700 transition duration-300 text-sm sm:text-base">
                  Join Our Mission
                </button>
              </div>
            </div>
